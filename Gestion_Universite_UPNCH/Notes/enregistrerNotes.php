<?php
  ...
  require '../Etudiant/TraitementEtudiant.php';
  require '../Cours/TraitementCours.php';
                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="TraitementNotes.php" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php 
                                                    ...
                                                    $query =$sdPDO->query("SELECT* FROM anneacademique  ");
                                                    $query->execute();
                                                    $resultat = $query->fetchAll();
                                    ...
                                    <input class="btn btn-primary" type="submit" name="optionNote" value="Enregistrer" />
