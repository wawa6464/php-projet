                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="notes" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="../Notes/afficherNotes.php">Affiche</a>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="TraitementNotes.php" method="post">
                                ~
                                  <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="ID"
                                                    id="ID" required="required" readonly="readonly"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="Sessione" size=1 >
                                                <?php 
                                                        ...
                                                        $query =$sdPDO->query("SELECT* FROM cours ");
                                                        $query->execute();
                                                        $resultat = $query->fetchAll();


                                                      foreach($resultat as $output){  ?>
                                                        <option ><?php echo $output['Sessione']; ?> </option>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="Code" class="col-sm-2 col-form-label">Code etudiant</label>
                                            <div class="col-sm-10">
                                                ...
                                                <?php 
                                                    ...
                                                    $resultat = $query->fetchAll();
                                                      ...
                                                      foreach($resultat as $output){  ?>
                                                        <option ><?php echo $output['Code']; ?> </option>
                                        ...
                                        <div class="col-md-6">
                                            <label for="CodeCours" class="col-sm-2 col-form-label">Code cours </label>
                                            <div class="col-sm-10">
                                            <select name="CodeCours" size=1
                                            value="<?php 
                                                    foreach($datas as $output){  ?>
                                                        <?php echo $output['CodeCours']; ?> 
                                                <?php }?>"
                                            >
                                                <?php 
                                                        ...
                                                        $resultat = $query->fetchAll();
                                                               ...
                                                               foreach($resultat as $output){  ?>
                                                        <option ><?php echo $output['CodeCours']; ?> </option>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" name="Note"
                                                    id="Note" required="required" min=0 max=100 
                                                    value="<?php 
                                                    foreach($data22 as $dat){  ?>
                                                        <?php echo $dat['Note']; ?> 
                                                <?php }?>"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            value="<?php 
                                                    foreach($datas as $output){  ?>
                                                        <?php echo $output['AnneeAcademique']; ?> 
                                                <?php }?>"
                                            >
                                            <?php 
                                                    

                                                    $query =$sdPDO->query("SELECT* FROM anneeacademique  ");
                                                    $query->execute();
                                                    $resultat = $query->fetchAll();
                                    ...
                                    <input class="btn btn-primary" type="submit" name="updateNote" value="Enregistrer" />
