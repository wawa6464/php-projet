...
require '../Dbconnect/Connexion.php';
 ...
 $sql = "SELECT nt.*,cr.*, et.*  FROM  cours cr, notes nt ,etudiant et WHERE  cr.CodeCours= nt.CodeCours 
    and cr.CodeCours = et.CodeCours and nt.CodeCours= et.Codecours";
