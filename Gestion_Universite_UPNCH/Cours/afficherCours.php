                                ...
                                <div class="card mb-4">
                                    ...
                                    <?php foreach($datas as $data) : ?>
                                            <tr>
                                                ...
                                                <td><?= $data['ProfTitulaire'] ?></td>
                                                <td><?= $data['ProfSuppleant'] ?></td>
                                                <td><?= $data['Jours'] ?></td>
                                                ...
                                                <td>
                                                <a href="updateCours.php?CodeCours=<?= $data['CodeCours']?>">modifier</a>
                                                <a href="deleteCours.php?CodeCours=<?=$data['CodeCours'] ?>">supprimer</a>
                                                </td>
