...
<body class="sb-nav-fixed">
    ...
    <?php foreach($datas as $data) : ?>
            <tr>
                ...
                <td><?= $data['Etat'] ?></td>
                <td><?= $data['ModulesDacces'] ?></td>
               
                <td>
                <a href="updateUtilisateur.php?IdUtilisateur=<?= $data['IdUtilisateur']?>">modifier</a>
                <a href="deleteUtilisateur.php?IdUtilisateur=<?=$data['IdUtilisateur'] ?>">supprimer</a>
                </td>
