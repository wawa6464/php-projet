                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <h4> Enregistrer des utilisateurs</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="TraitementUtilisateur.php" method="post">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="MotDePasse" class="col-sm-2 col-form-label">Mot passe</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="MotDePasse"
                                                    id="MotDepasse" required="required">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="ModulesDacces" class="col-sm-2 col-form-label">modulesAccès</label>
                                            <div class="col-sm-10">
                                        ...
                                        <input class="btn btn-primary" type="submit" name="optionUtilisateur" value="Enregistrer" />
