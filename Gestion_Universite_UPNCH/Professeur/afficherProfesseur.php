...
<body class="sb-nav-fixed">
    ...
    <?php foreach($datas as $data) : ?>
            <tr>
                ...
                <td><?= $data['matrimonial'] ?></td>
                <td><?= $data['LieuNaissance'] ?></td>
                <td><?= $data['DateNaissance'] ?></td>
                <td><?= $data['Niveau'] ?></td>
                <td><?= $data['CoursEnsegner'] ?></td>
                <td><?= $data['FilliereAffecte'] ?></td>
                <td><?= $data['Salaire'] ?></td>
                <td><?= $data['Poste'] ?></td>
                <td><?= $data['Email'] ?></td>
                <td><?= $data['NIFCIN'] ?></td>
                ...
                <td>
                <a href="updateprofesseur.php?Code=<?= $data['Code']?>">modifier</a>
                <a href="deleteProfesseur.php?Code=<?=$data['Code'] ?>">supprimer</a>
                </td>
